...
-- ==============================================================================
-- 5. TABLE: words_v2 (Multi-language, JSONB-first)
-- Description: Identity columns + content JSONB for language-agnostic storage.
-- Replaces the need for etymologies/cognates/examples/synonyms sub-tables.
-- Old tables (words, etymologies, cognates, examples, synonyms, user_requests)
...
COMMENT ON TABLE words_v2 IS 'Multi-language word storage with JSONB content column. Identity columns for querying, content JSONB as single source of truth.';
...
CREATE INDEX IF NOT EXISTS idx_words_v2_content
    ON words_v2 USING GIN (content);
